...
public:
  enum {
    ...
    LineComment = 38, BlockComment = 39
  };
  ...
  enum {
    ...
    RuleConstExp = 30, RuleEpsilon = 31
  };
  ...
  class  SingleConstInitValContext : public ConstInitValContext {
  public:
    SingleConstInitValContext(ConstInitValContext *ctx);
  ...
  class  MultiConstInitValContext : public ConstInitValContext {
  public:
    MultiConstInitValContext(ConstInitValContext *ctx);
  ...
  class  NoinitVarDefContext : public VarDefContext {
  public:
    NoinitVarDefContext(VarDefContext *ctx);
  ...
  class  SingleInitValContext : public InitValContext {
  public:
    SingleInitValContext(InitValContext *ctx);
  ...
  class  MultiInitValContext : public InitValContext {
  public:
    MultiInitValContext(InitValContext *ctx);
  ...
  class  ParensPrimaryExpContext : public PrimaryExpContext {
  public:
    ParensPrimaryExpContext(PrimaryExpContext *ctx);
  ...
  class  EpsilonContext : public antlr4::ParserRuleContext {
  public:
    EpsilonContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
