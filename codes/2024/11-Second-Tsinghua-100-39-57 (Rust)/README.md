...
```
cd existing_repo
git remote add origin https://gitlab.eduxiji.net/rrvm-project/sysyc.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.eduxiji.net/rrvm-project/sysyc/-/settings/integrations)
