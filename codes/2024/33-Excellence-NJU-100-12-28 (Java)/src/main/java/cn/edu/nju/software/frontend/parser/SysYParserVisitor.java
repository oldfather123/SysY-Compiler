...
public interface SysYParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SysYParser#funcUse}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFuncUse(SysYParser.FuncUseContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SysYParser#elseStmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElseStmt(SysYParser.ElseStmtContext ctx);
	/**
