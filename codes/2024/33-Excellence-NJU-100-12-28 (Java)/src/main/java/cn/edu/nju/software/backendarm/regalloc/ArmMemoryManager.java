...
public class ArmMemoryManager {

    private int size = 0;
    private final Map<String, Integer> memoryAddr = new HashMap<>();
    private final HashSet<String> hasAllocatedPtr = new HashSet<>();
    private static final ArmMemoryManager armMemoryManager = new ArmMemoryManager();

    private ArmMemoryManager() {}

    public static ArmMemoryManager get() {
        return armMemoryManager;
    }
