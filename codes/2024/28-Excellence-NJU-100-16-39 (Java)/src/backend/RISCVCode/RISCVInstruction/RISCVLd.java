...
public class RISCVLd extends RISCVInstruction {
    ...
    public RISCVLd(RISCVOperand dest, RISCVOperand operand1) {
        this.dest = dest;
    ...
    public RISCVOperand getDest(){return this.dest;}
    public RISCVOperand getOperand1(){return this.operand1;}
}
