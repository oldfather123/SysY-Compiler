...
class BasicBlock : public Value, public ADT::ilist_node<BasicBlock> {
  public:
    ~BasicBlock() = default;
    ...
    ADT::ilist<Instruction> &get_instructions() { return instr_list_; }
  ...
  private:
    ...
    ADT::ilist<Instruction> instr_list_;
    Function *parent_;
};
