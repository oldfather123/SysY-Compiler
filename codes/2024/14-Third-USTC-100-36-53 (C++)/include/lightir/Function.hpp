...
class Function : public Value, public ADT::ilist_node<Function> {
  public:
    ...
    ADT::ilist<BasicBlock> &get_basic_blocks() { return basic_blocks_; }
  ...
  private:
    ADT::ilist<BasicBlock> basic_blocks_;
