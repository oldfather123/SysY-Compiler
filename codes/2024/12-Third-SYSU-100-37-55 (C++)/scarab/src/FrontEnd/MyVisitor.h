...
public:
  ...
  VariablePtr initializeArrayItem(SysY2022Parser::ItemConstInitValContext *ctx, TypePtr type);
  shared_ptr<Arr> initializeArrayList(SysY2022Parser::ListConstInitValContext *ctx, TypePtr type);
  VariablePtr initializeArrayItem(SysY2022Parser::ItemInitValContext *ctx, TypePtr type);
  shared_ptr<Arr> initializeArrayList(SysY2022Parser::ListInitValContext *ctx, TypePtr type);
  void setArrayList(SysY2022Parser::ListInitValContext *ctx, ValuePtr value);
  
  virtual antlrcpp::Any visitVarDefWithInitVal(SysY2022Parser::VarDefWithInitValContext *ctx) override;

  bool parseInitValue(SysY2022Parser::InitValContext *ctx);
