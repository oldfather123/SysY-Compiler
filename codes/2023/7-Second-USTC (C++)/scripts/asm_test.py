...
LIB_PATH = os.path.abspath("lib/sylib.c")

TEST_DIRS = [
    "tests/functional",
    "tests/hidden_functional",
    # "tests/performance",
    "tests/final_performance",
]
...
def evaluate(test_base_path, testcases):
    ...
    for index, case in enumerate(testcases):
        ...
        ASM_GEN_PTN = [EXE_PATH, "-S", sy_path, "-O1"]
        EXE_GEN_PTN = ["riscv64-linux-gnu-gcc", "-o", exe_path, asm_path, LIB_PATH]
        EXE_PTN = ["qemu-riscv64", exe_path]
