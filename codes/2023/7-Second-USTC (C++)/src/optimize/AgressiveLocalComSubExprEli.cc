...
void AgressiveLocalComSubExprEli::execute(){
...
void AgressiveLocalComSubExprEli::get_eliminatable_call(){
    for(auto func: module_->get_functions()){
        auto can_eli = true;
...
bool AgressiveLocalComSubExprEli::is_call_eliminatable(std::string func_id) {
...
Arglist *AgressiveLocalComSubExprEli::get_call_args(CallInst *instr) {
...
void AgressiveLocalComSubExprEli::delete_expr_local(BasicBlock* bb){
    //get pre_info
