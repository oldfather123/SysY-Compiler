...
const int reg_gp = 3;        //~ 全局指针
const int reg_tp = 4;        //~ 线程指针
const int reg_t0 = 5;        
const int reg_t1 = 6;
const int reg_t2 = 7;
const int reg_s0 = 8;  const int reg_fp = 8;  //~ 帧指针
const int reg_s1 = 9;
const int reg_a0 = 10;       
const int reg_a1 = 11;       
const int reg_a2 = 12;
...
const int reg_fs0 = 8;
const int reg_fs1 = 9;
const int reg_fa0 = 10;
const int reg_fa1 = 11;
const int reg_fa2 = 12;
const int reg_fa3 = 13;
const int reg_fa4 = 14;
const int reg_fa5 = 15;
const int reg_fa6 = 16;
const int reg_fa7 = 17;
const int reg_fs2 = 18;
const int reg_fs3 = 19;
const int reg_fs4 = 20;
const int reg_fs5 = 21;
const int reg_fs6 = 22;
const int reg_fs7 = 23;
const int reg_fs8 = 24;
const int reg_fs9 = 25;
const int reg_fs10 = 26;
const int reg_fs11 = 27;
const int reg_ft8 = 28;
const int reg_ft9 = 29;
const int reg_ft10 = 30;
const int reg_ft11 = 31;
