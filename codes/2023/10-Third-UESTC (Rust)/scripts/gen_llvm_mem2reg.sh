...
if (($# >= 1)); then
	...
	echo "use it like $: sh ./scripts/gen_llvm_mem2reg.sh test/functional/30_continue.ll output/mem2reg/functional/ or \
$: sh ./scripts/gen_llvm_mem2reg.sh test/functional/ output/mem2reg/functional/"
fi
