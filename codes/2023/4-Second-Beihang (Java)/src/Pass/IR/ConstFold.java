            ...
            for(IList.INode<BasicBlock, Function> bbNode : function.getBbs()) {
                ...
                for(IList.INode<Instruction, BasicBlock> instNode : bb.getInsts()){
                    ...
                    if(constInt.getValue() == 1){
                        BasicBlock removedNxtBb = brInst.getFalseBlock();
                        ...
                        BasicBlock removedNxtBb = brInst.getTrueBlock();
                        ArrayList<Phi> phis = UtilFunc.getPhiInBb(removedNxtBb);
                        int idx = removedNxtBb.getPreBlocks().indexOf(bb);
                        for(Phi phi : phis){
                            phi.removeOperand(idx);
...
//        if (value instanceof ConversionInst conversionInst && conversionInst.getOp().equals(OP.Itof)){
//            return conversionInst.getValue();
//        }
        return ftoiInst;
    }
...
//        if (value instanceof ConversionInst conversionInst && conversionInst.getOp().equals(OP.Ftoi)){
//            return conversionInst.getValue();
//        }
        return itofInst;
    }
