...
public:
  ...
  virtual void enterIfStruct(SysYParser::IfStructContext *ctx) = 0;
  virtual void exitIfStruct(SysYParser::IfStructContext *ctx) = 0;

  virtual void enterWhileStruct(SysYParser::WhileStructContext *ctx) = 0;
  virtual void exitWhileStruct(SysYParser::WhileStructContext *ctx) = 0;
