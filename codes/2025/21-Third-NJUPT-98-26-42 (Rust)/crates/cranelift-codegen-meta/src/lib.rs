...
// mod gen_asm;  // Removed for RISCV-only build
mod gen_inst;
mod gen_isle;
mod gen_settings;
mod gen_types;
...
// x64 assembler generation functions removed for RISCV-only build
...
pub fn generate(
    ...
    // x64 assembler generation removed for RISCV-only build
