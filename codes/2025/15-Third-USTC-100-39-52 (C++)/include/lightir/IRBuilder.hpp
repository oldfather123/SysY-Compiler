...
public:
    ...
    // ICmpInst *create_icmp_iiand(Value *lhs, Value *rhs)
    // {
    //     return ICmpInst::create_iiadd(lhs, rhs, this->BB_);
    // }
    ...
    // IBinaryInst *create_and(Value *lhs, Value *rhs)
    // {
    //     return IBinaryInst::create_and(lhs, rhs, this->BB_);
    // }
    AndInst *create_and(Value *lhs, Value *rhs){
        return AndInst::create_iiand(lhs, rhs, this->BB_);
    }

    MqtInst *create_mqt(Value *base_ptr, Value *offset) 
    {
        return MqtInst:: create_mqt(base_ptr, offset, this->BB_);
    }
};
