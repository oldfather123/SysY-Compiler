 ...
 */
public class StoreToLoadForwarding {
    ...
    public static void execute(List<Function> functions, SymTab globalSymTab) {
        StoreToLoadForwarding.globalSymTab = globalSymTab;
        ...
        for (Set<Function> comp : order) {
            ...
            for (Function f : comp) {
                ...
                StoreToLoadForwarding.curFunction = f;
    ...
    private static void handleLoad(LoadInstr load) {
        ...
        if (addr instanceof GEPInstr gep) {
            ...
            if (arrayStoreMap.containsKey(base) && arrayStoreMap.get(base).containsKey(key) &&
            ...
            } else if (base instanceof GlbObjPtr glbBase &&
                ...
                if (val instanceof ArrayInitVal.ArrayZeroInitVal) {
                    if (load.getType() instanceof TInt) {
                        val = IntConst.Zero;
                    } else {
                        val = FloatConst.Zero;
                    }
