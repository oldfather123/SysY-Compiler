...
public class ParallelLib {
    public static boolean need(ASMModel riscvModule) {
        return riscvModule.hasParallel();
    }

    public static final String model = """
            .file\t"OHM_sysy_rt.cpp"
            \t.option pic
            ...
            \t.text
            \t.align\t1
            \t.type\t_ZN12_GLOBAL__N_110OHMWorkerEPv, @function
            _ZN12_GLOBAL__N_110OHMWorkerEPv:
            .LFB1259:
            \t.cfi_startproc
            \taddi\tsp,sp,-192
            ...
            \t.cfi_endproc
            .LFE1259:
            \t.size\t_ZN12_GLOBAL__N_110OHMWorkerEPv, .-_ZN12_GLOBAL__N_110OHMWorkerEPv
            \t.section\t.text.startup,"ax",@progbits
            \t.align\t1
            \t.globl\tOHMInitRuntime
            \t.type\tOHMInitRuntime, @function
            OHMInitRuntime:
            .LFB1260:
            \t.cfi_startproc
            \taddi\tsp,sp,-64
            ...
            \tsd\ts5,8(sp)
            \t.cfi_offset 21, -56
            \tlla\ts5,_ZN12_GLOBAL__N_110OHMWorkerEPv
            \tsd\ts6,0(sp)
            \t.cfi_offset 22, -64
            \tli\ts6,1
            \tsd\tra,56(sp)
            ...
            \t.cfi_endproc
            .LFE1260:
            \t.size\tOHMInitRuntime, .-OHMInitRuntime
            \t.section\t.init_array,"aw"
            \t.align\t3
            \t.dword\tOHMInitRuntime
            \t.section\t.text.exit,"ax",@progbits
            \t.align\t1
            \t.globl\tOHMUninitRuntime
            \t.type\tOHMUninitRuntime, @function
            OHMUninitRuntime:
            .LFB1261:
            \t.cfi_startproc
            \taddi\tsp,sp,-32
            ...
            \t.cfi_endproc
            .LFE1261:
            \t.size\tOHMUninitRuntime, .-OHMUninitRuntime
            \t.section\t.fini_array,"aw"
            \t.align\t3
            \t.dword\tOHMUninitRuntime
            \t.text
            \t.align\t1
            \t.globl\tOHMParallelFor
            \t.type\tOHMParallelFor, @function
            OHMParallelFor:
            .LFB1265:
            \t.cfi_startproc
            \tbge\ta0,a1,.L116
            ...
            \t.cfi_endproc
            .LFE1265:
            \t.size\tOHMParallelFor, .-OHMParallelFor
            \t.align\t1
            \t.globl\tOHMCacheLookup
            \t.type\tOHMCacheLookup, @function
            OHMCacheLookup:
            .LFB1267:
            \t.cfi_startproc
            \tslli\ta1,a1,32
            ...
            \t.cfi_endproc
            .LFE1267:
            \t.size\tOHMCacheLookup, .-OHMCacheLookup
            \t.align\t1
            \t.globl\tOHMAddRec3SRem
            \t.type\tOHMAddRec3SRem, @function
            OHMAddRec3SRem:
            .LFB1268:
            \t.cfi_startproc
            \taddi\ta5,a0,-1
            ...
            \t.cfi_endproc
            .LFE1268:
            \t.size\tOHMAddRec3SRem, .-OHMAddRec3SRem
            \t.align\t1
            \t.globl\tOHMReduceAddI32
            \t.type\tOHMReduceAddI32, @function
            OHMReduceAddI32:
            .LFB1269:
            \t.cfi_startproc
            ...
            \t.cfi_endproc
            .LFE1269:
            \t.size\tOHMReduceAddI32, .-OHMReduceAddI32
            \t.align\t1
            \t.globl\tOHMReduceAddF32
            \t.type\tOHMReduceAddF32, @function
            OHMReduceAddF32:
            .LFB1270:
            \t.cfi_startproc
            \taddi\tsp,sp,-16
            ...
            \t.cfi_endproc
            .LFE1270:
            \t.size\tOHMReduceAddF32, .-OHMReduceAddF32
            \t.bss
            \t.align\t3
            \t.set\t.LANCHOR0,. + 0
