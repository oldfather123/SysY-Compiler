...
public abstract class RVArithmetic extends RVIns implements PureIns {
    protected ASMValue operand1;
    protected ASMValue operand2;
    
    protected RVArithmetic(Reg operand1, ASMValue operand2, ASMBasicBlock parentBlock, Reg reg) {
