...
public class RVSrl extends RVArithmetic implements ShiftIns {
    public RVSrl(Reg operand1, ASMImmediate operand2, ASMBasicBlock parentBlock, Reg reg) {
