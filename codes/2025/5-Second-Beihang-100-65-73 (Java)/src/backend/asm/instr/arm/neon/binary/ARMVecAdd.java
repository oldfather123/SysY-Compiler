...
public class ARMVecAdd extends ARMVecBinary {
    public ARMVecAdd(VirFReg operand1, VirFReg operand2, ASMBasicBlock parentBlock, VirFReg reg) {
    ...
    protected String printIns() {
        ...
        return "ADD " + fReg0.printAsFullVec() + ", " + fReg1.printAsFullVec() + ", " +
