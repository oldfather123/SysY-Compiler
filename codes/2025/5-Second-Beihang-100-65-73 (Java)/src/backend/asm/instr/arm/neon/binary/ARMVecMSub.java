...
/**
 * 注意，被定义的寄存器的旧值也是操作数
 * MLS Vd.<T>, Vn.<T>, Vm.<T>     // Vd[i] -= Vn[i] * Vm[i]
 */
public class ARMVecMSub extends ARMVecBinary {
    public ARMVecMSub(VirFReg operand1, VirFReg operand2, ASMBasicBlock parentBB, VirFReg reg) {
    ...
    protected String printIns() {
        ...
        return "MLS " + fReg0.printAsFullVec() + ", " + fReg1.printAsFullVec() + ", " +
