...
public class ARMItof extends ARMIns implements PureIns {
    private Reg src;

    public ARMItof(Reg src, ASMBasicBlock block, Reg reg) {
        super(block, reg);
        this.src = src;
    ...
    protected String printIns() {
        return "SCVTF " + this.printAsOperand() + ", " + src.printAsOperand();
    }
}
