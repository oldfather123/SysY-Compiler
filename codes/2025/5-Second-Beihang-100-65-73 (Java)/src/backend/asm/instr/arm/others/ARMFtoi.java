...
public class ARMFtoi extends ARMIns implements PureIns {
    private Reg src;

    public ARMFtoi(Reg src, ASMBasicBlock block, Reg reg) {
        super(block, reg);
        this.src = src;
    ...
    protected String printIns() {
        return "FCVTZS " + this.printAsOperand() + ", " + src.printAsOperand();
    }
}
